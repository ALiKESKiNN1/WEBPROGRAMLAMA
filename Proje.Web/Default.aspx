...
<head runat="server">
 <meta charset="UTF-8"/>
    ...
    <!-- Css Styles -->
    <link rel="stylesheet" href="/TASARIM/css/bootstrap.min.css" type="text/css"/>
    <link rel="stylesheet" href="/TASARIM/css/font-awesome.min.css" type="text/css"/>
    <link rel="stylesheet" href="/TASARIM/css/elegant-icons.css" type="text/css"/>
    <link rel="stylesheet" href="/TASARIM/css/owl.carousel.min.css" type="text/css"/>
    <link rel="stylesheet" href="/TASARIM/css/slicknav.min.css" type="text/css"/>
    <link rel="stylesheet" href="/TASARIM/css/style.css" type="text/css"/>
</head>
<body>
    ...
    <div class="humberger__menu__wrapper">
        <div class="humberger__menu__logo">
            <a href="./index.html"></TASARIM/img src="/TASARIM/img/humberger/humberger-logo.png" alt=""></a>
        </div>
        ...
        <div class="humberger__menu__about">
            ...
            </TASARIM/img src="/TASARIM/img/humberger/humberger-about.jpg" alt="">
                                        ...
                                        <div class="header__megamenu">
                                            <div class="header__megamenu__item">
                                                <div class="header__megamenu__item--pic set-bg"
                                                    data-setbg="/TASARIM/img/megamenu/p-1.jpg">
                                            ...
                                            <div class="header__megamenu__item">
                                                <div class="header__megamenu__item--pic set-bg"
                                                    data-setbg="/TASARIM/img/megamenu/p-2.jpg">
                                                    <div class="label">Vegan</div>
                                                </div>
                                                <div class="header__megamenu__item--text">
                                                    <h5><a href="#">How to Make a Milkshake With Any Ice Cream ...</a>
                                            ...
                                            <div class="header__megamenu__item">
                                                <div class="header__megamenu__item--pic set-bg"
                                                    data-setbg="/TASARIM/img/megamenu/p-3.jpg">
                                                    <div class="label">Vegan</div>
                                                </div>
                                                <div class="header__megamenu__item--text">
                                                    <h5><a href="#">How to Make a Milkshake With Any Ice Cream ...</a>
                                            ...
                                            <div class="header__megamenu__item">
                                                <div class="header__megamenu__item--pic set-bg"
                                                    data-setbg="/TASARIM/img/megamenu/p-4.jpg">
                                                    <div class="label">Vegan</div>
                                                </div>
                                                <div class="header__megamenu__item--text">
                                                    <h5><a href="#">How to Make a Milkshake With Any Ice Cream ...</a>
                                            ...
                                            <div class="header__megamenu__item">
                                                <div class="header__megamenu__item--pic set-bg"
                                                    data-setbg="/TASARIM/img/megamenu/p-5.jpg">
                                                    <div class="label">Vegan</div>
                                                </div>
                                                <div class="header__megamenu__item--text">
                                                    <h5><a href="#">How to Make a Milkshake With Any Ice Cream ...</a>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="header__logo">
                        <a href="./index.html"></TASARIM/img src="/TASARIM/img/logo.png" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3">
                    ...
                    <div class="row">
                        <div class="col-lg-6 p-0">
                            <div class="hero__inside__item hero__inside__item--wide set-bg"
                                data-setbg="/TASARIM/img/hero/hero-1.jpg">
                        ...
                        <div class="col-lg-3 col-md-6  p-0">
                            <div class="hero__inside__item hero__inside__item--small set-bg"
                                data-setbg="/TASARIM/img/hero/hero-2.jpg">
                                <div class="hero__inside__item__text">
                                    <div class="hero__inside__item--meta">
                                        <span>08</span>
                                        <p>Aug</p>
                            ...
                            <div class="hero__inside__item hero__inside__item--small set-bg"
                                data-setbg="/TASARIM/img/hero/hero-3.jpg">
                                <div class="hero__inside__item__text">
                                    <div class="hero__inside__item--meta">
                                        <span>08</span>
                                        <p>Aug</p>
                        ...
                        <div class="col-lg-3 col-md-6  p-0">
                            <div class="hero__inside__item set-bg" data-setbg="/TASARIM/img/hero/hero-4.jpg">
                                <div class="hero__inside__item__text">
                                    <div class="hero__inside__item--meta">
                                        <span>08</span>
                                        <p>Aug</p>
                    ...
                    <div class="col-lg-8 col-md-8">
                        <div class="categories__post__item categories__post__item--large">
                            <div class="categories__post__item__pic set-bg"
                                data-setbg="/TASARIM/img/categories/categories-post/cp-1.jpg">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="categories__post__item">
                                    <div class="categories__post__item__pic small__item set-bg"
                                        data-setbg="/TASARIM/img/categories/categories-post/cp-2.jpg">
                                        <div class="post__meta">
                                            <h4>08</h4>
                                            <span>Aug</span>
                                        </div>
                                ...
                                <div class="categories__post__item">
                                    <div class="categories__post__item__pic set-bg"
                                        data-setbg="/TASARIM/img/categories/categories-post/cp-4.jpg">
                                        <div class="post__meta">
                                            <h4>08</h4>
                                            <span>Aug</span>
                                        </div>
                                ...
                                <div class="categories__post__item__plain set-bg"
                                    data-setbg="/TASARIM/img/categories/categories-post/cp-6.jpg">
                                    <div class="categories__post__item__text">
                                        <div class="post__meta">
                                            <h4>08</h4>
                                            <span>Aug</span>
                                ...
                                <div class="categories__post__item">
                                    <div class="categories__post__item__pic smaller__large set-bg"
                                        data-setbg="/TASARIM/img/categories/categories-post/cp-8.jpg">
                                        <div class="post__meta">
                                            <h4>08</h4>
                                            <span>Aug</span>
                                        </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="categories__post__item">
                                    <div class="categories__post__item__pic smaller__large set-bg"
                                        data-setbg="/TASARIM/img/categories/categories-post/cp-3.jpg">
                                        <div class="post__meta">
                                            <h4>08</h4>
                                            <span>Aug</span>
                                        </div>
                                ...
                                <div class="categories__post__item__small">
                                    </TASARIM/img src="/TASARIM/img/categories/categories-post/quote.png" alt="">
                                ...
                                <div class="categories__post__item">
                                    <div class="categories__post__item__pic smaller__large set-bg"
                                        data-setbg="/TASARIM/img/categories/categories-post/cp-5.jpg">
                                        <div class="post__meta">
                                            <h4>08</h4>
                                            <span>Aug</span>
                                        </div>
                                ...
                                <div class="categories__post__item">
                                    <div class="categories__post__item__pic set-bg"
                                        data-setbg="/TASARIM/img/categories/categories-post/cp-7.jpg">
                                        <div class="post__meta">
                                            <h4>08</h4>
                                            <span>Aug</span>
                                        </div>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="sidebar__item">
                            <div class="sidebar__about__item">
                                ...
                                </TASARIM/img src="/TASARIM/img/sidebar/sidebar-about.jpg" alt="">
                            ...
                            <div class="sidebar__item__banner">
                                </TASARIM/img src="/TASARIM/img/sidebar/banner.jpg" alt="">
                            </div>
            ...
            <div class="footer__instagram">
                <div class="footer__instagram__avatar">
                    <div class="footer__instagram__avatar--pic">
                        </TASARIM/img src="/TASARIM/img/footer/instagram-avatar.jpg" alt="">
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-2 col-md-2 col-sm-4 col-6">
                        <div class="footer__instagram__item set-bg" data-setbg="/TASARIM/img/footer/ip-1.jpg"></div>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-4 col-6">
                        <div class="footer__instagram__item set-bg" data-setbg="/TASARIM/img/footer/ip-2.jpg"></div>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-4 col-6">
                        <div class="footer__instagram__item set-bg" data-setbg="/TASARIM/img/footer/ip-3.jpg"></div>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-4 col-6">
                        <div class="footer__instagram__item set-bg" data-setbg="/TASARIM/img/footer/ip-4.jpg"></div>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-4 col-6">
                        <div class="footer__instagram__item set-bg" data-setbg="/TASARIM/img/footer/ip-5.jpg"></div>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-4 col-6">
                        <div class="footer__instagram__item set-bg" data-setbg="/TASARIM/img/footer/ip-6.jpg"></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="footer__text">
                        <div class="footer__logo">
                            <a href="#"></TASARIM/img src="/TASARIM/img/logo.png" alt=""></a>
                        </div>
  ...
  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
    ...
    <!-- Js Plugins -->
    <script src="/TASARIM/js/jquery-3.3.1.min.js"></script>
    <script src="/TASARIM/js/bootstrap.min.js"></script>
    <script src="/TASARIM/js/jquery.slicknav.js"></script>
    <script src="/TASARIM/js/owl.carousel.min.js"></script>
